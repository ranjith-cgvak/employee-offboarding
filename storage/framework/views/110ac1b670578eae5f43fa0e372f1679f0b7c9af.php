                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <?php if(\Auth::User()->department_id != 7): ?>
                                                    <td><?php echo e($leadGeneralComment ? $leadGeneralComment['comment'] : ''); ?></td>
                                                    
                                                    <td><?php echo e($leadDolComment ? $leadDolComment['comment'] : ''); ?></td>
                                                    <?php endif; ?>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <?php if(\Auth::User()->department_id != 7): ?>
                                                    <td><?php echo e($headGeneralComment ? $headGeneralComment['comment'] : ''); ?></td>
                                                    
                                                    
                                                    <td><?php echo e($converted_dates['changed_dol'] ? $converted_dates['changed_dol'] : ''); ?></td>
                                                    <td><?php echo e($headDolComment ? $headDolComment['comment'] : ''); ?></td>
                                                    <?php endif; ?>
                                                </tr>
                                                <tr>
                                                    <td>HR</td>
                                                    ...
                                                    <?php if(\Auth::User()->department_id != 7): ?>
                                                    <td><?php echo e($hrGeneralComment ? $hrGeneralComment['comment'] : ''); ?></td>
                                                    
                                                    
                                                    <td><?php echo e($converted_dates['changed_dol'] ? $converted_dates['changed_dol'] : ''); ?></td>
                                                    <td><?php echo e($hrDolComment ? $hrDolComment['comment'] : ''); ?></td>
                                                    <?php endif; ?>
                                                </tr>
                                            </tbody>
                                        </table>
...
<?php echo $__env->make('layouts.app_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\OfzProjects\Laravel\employee-offboarding\resources\views/process/viewResignation.blade.php ENDPATH**/ ?>