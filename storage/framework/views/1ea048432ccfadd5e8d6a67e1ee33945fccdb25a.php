        ...
        <div class="col-md-12">
            ...
            <div class="progress_content" >
                <div class="arrow-steps clearfix">
                    <a href="<?php echo e(route('acceptanceStatus')); ?>" class="step <?php echo e(($noDueStatus == NULL) ? 'current' : 'current_prev'); ?>"><div> <span> 1.Acceptance  </span> </div></a>
...
<?php echo $__env->make('layouts.app_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Office projects\employee-offboarding\resources\views/resignation/progress.blade.php ENDPATH**/ ?>